...
public class ProductInfoDTO {
	...
	private String productPurchaseTotal; //商品個数売り上げ個数
	...
	public String getProductPurchaseTotal() {
		return productPurchaseTotal;
	}

	public void setProductPurchaseTotal(String productPurchaseTotal) {
		this.productPurchaseTotal = productPurchaseTotal;
	}
}